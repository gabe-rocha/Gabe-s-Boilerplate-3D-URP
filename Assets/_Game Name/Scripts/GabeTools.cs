...
public static class GabeTools
{
	...
	//		SpriteRenderer sr = toast.AddComponent<SpriteRenderer>();
	//		toast.transform.localScale = new Vector3(3f, 2f, 1f);

	//		var font = Resources.GetBuiltinResource(typeof(Font), "Arial.ttf") as Font;
	//		CodeMonkey.Utils.UtilsClass.DrawTextUI("asdf", Vector2.zero, 36, font);
	//	}
	//}
	...
	// PLAYER PREFS X
	//
	/* from http://wiki.unity3d.com/index.php/ArrayPrefs2#C.23_-_PlayerPrefsX.cs */
	//------------------------------------------------------------------------------------------------------------------------------------
