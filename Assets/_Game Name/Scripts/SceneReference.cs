...
public class SceneReferencePropertyDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        EditorGUI.BeginProperty(position, GUIContent.none, property);
        {
            ...
            //if (property.isExpanded)
            {
                ...
                GUI.Box(EditorGUI.IndentedRect(DrawUtils.GetFieldRect(position)), GUIContent.none, EditorStyles.helpBox);
                ...
                EditorGUI.BeginChangeCheck();
                {
                    ...
                    sceneAssetProperty.objectReferenceValue = EditorGUI.ObjectField(DrawUtils.GetFieldRect(position), sceneAssetProperty.objectReferenceValue, typeof(SceneAsset), false);
                }
    ...
    private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
    {
        ...
        using (new EditorGUI.DisabledScope(readOnly))
        {
            ...
            labelRect.width -= iconRect.width + 20f;
            labelRect.x += 20f + iconRect.width;
